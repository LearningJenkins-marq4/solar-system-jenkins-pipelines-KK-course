@Library('kodekloud-learning-jenkins-trusted-groovy-libraries@feature/trivy-scan') _
...
pipeline {
  ...
  stages {
    ...
    stage('Display message (using Shared Libraries)') {
      steps {
...
*/
      ...
      stages {
        ...
        stage('Trivy') {
          steps {
            ...
            script {
              trivyScan.scan(dockerImage.imageName())
            }
          }
        }
        /*
    ...
    */
    ...
    stage('Integration testing') {
      ...
      steps {
        withAWS(region: 'us-west-2', credentials: 'aws-jenkins-technical-user-creds') {
